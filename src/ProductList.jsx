...
function ProductList({ onHomeClick }) {
    ...
    const numericCost = Number(plant.cost.toString().replace("$", ""));
    ...
    setShowCart(false); 
                    ...
                    <a href="#" onClick={handleCartClick} style={linkStyle} className="cart-link">
  <div className="cart-wrapper">
    ...
    {cartCount > 0 && <span className="cart-number">{cartCount}</span>}
  </div>
</a>
